...
<body>
    ...
    <div id="wrapper">
            ...
            <name  >Hi ! <?php 
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li class="divider"></li>
                        <li>
                            <a href="check.php"><i class="fa fa-sign-out fa-fw"></i> Logout</a>
                        </li>
                    </ul>
                    <!-- /.dropdown-user -->
                </li>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"> แผนภูมิแสดงรถเมล์ที่ถูกประเมิน</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-6">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            แผนภูมิแสดงรถเมล์ที่ถูกประเมิน
                        </div>
                        <!-- /.panel-heading -->
