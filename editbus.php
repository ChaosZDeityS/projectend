      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <div class="card mb-3">
            ...
            <form method="GET" action = "temp_evaservicebus_insert.php" > 
        ...
        <?php
                        ...
                        while($row = mysqli_fetch_assoc($result)) {
                         // $buslineid = $row['buslineid'];
                          $questionbus = $row['questionbus'];
                          $id = $row['id'];
                        
                          echo "<input type='checkbox' name='link[]' value='$id' id='$id' >";
                          echo "<label for='$id'> &nbsp &nbsp &nbsp $count :&nbsp&nbsp$questionbus</label><br/>";
                          $count++;
