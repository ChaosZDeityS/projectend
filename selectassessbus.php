...
?>
  <head>
    ...
    $(document).ready(function(){
        ...
        //     var buslineid = $(this).val();
        //     alert("value in js " + buslineid);

        //     $.post('linkbus_fetch.php',{dropdownvalue : buslineid},function(data){
  ...
  <body id="page-top">
   ...
   <form action="selectassessforuse.php" action ="GET" >
   <?php
     // 1. Connect
     require("connect.php");
     // 2. Select SQL
     $sql = "SELECT noq  FROM selectassessbus GROUP BY noq";
     // 3. Execute SQL
