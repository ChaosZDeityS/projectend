...
<?php
    ...
    require 'connect.php' ; 
   // $sql =" TRUNCATE TABLE temp_selectassessdriver";
      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <div class="card mb-3">
            ...
            <form method="GET" action = "addassessdrivertemptoreal_insert.php" > 
        ...
        <?php
                        ...
                        $sql = "SELECT * FROM temp_selectassessdriver INNER JOIN evaservicedriver ON temp_selectassessdriver.questionno = evaservicedriver.id";
                        echo '   ชุดประเมินชื่อ : ' ;
                        // 3. Execute SQL
                        $result = mysqli_query($connection, $sql);
                        ...
                        if (mysqli_num_rows($result) > 0) {
                            ...
                            while($row = mysqli_fetch_assoc($result)) {
                                echo $count." : " . $row["questiondriver"]. "<br>";
                                $count++;
                            }
                        } else {
                            echo "0 results";
             ...
             <form method ="GET" action = "cancelassessdriver.php"> <br>
