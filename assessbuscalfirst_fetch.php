...
if(isset($_POST["search"]["value"]))
{
	if(isset($_POST["dropdownvalue"])){
		...
		$dropdown = $_POST["dropdownvalue"];
		$query .= 'WHERE scoreevaservicebus.busno LIKE "'.$_POST["dropdownvalue"].'%" ';
		
		$query .= 'OR scoreevaservicebus.score LIKE "'.$_POST["dropdownvalue"].'%" ';
...
foreach($result as $row)
{
	...
	$sub_array[] = "คันที่ ".$row["busno"] . " ด้าน" .$row["questionbus"];
